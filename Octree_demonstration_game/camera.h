...
namespace game {
    ...
    class Camera {
        ...
        public:
            ...
            void SetParentRotationAngle(glm::vec3 parentAngle);
            void SetParent_position(glm::vec3 newParentPosition);
            void SetParentRotation(glm::quat newParentRotation);
            void SetParentVelocity(glm::vec3 newParentVelocity);
